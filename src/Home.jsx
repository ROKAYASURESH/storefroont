    ...
    <div className="container-fluid">
        <div className="row">
            ...
            <div className="col-lg-6 p-5">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis pariatur nemo, debitis facere enim odio quos incidunt ut exercitationem laboriosam natus, consectetur reiciendis molestiae aliquid eaque nostrum consequatur dolore sint?</p>
            </div>
        </div>
    </div>
    <Product/>
